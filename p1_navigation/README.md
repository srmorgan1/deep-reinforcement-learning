...
For this project, we will train a Reinfocement Learning (RL) agent to navigate in a large, square world and
collect yellow bananas whilst avoiding blue bananas.

![Trained Agent][image1]

A reward of +1 is provided for collecting a yellow banana, and a reward of -1 is provided for collecting a blue banana.
Thus, the goal of the agent is to collect as many yellow bananas as possible whilst avoiding blue bananas.
...
The task is episodic, and in order to solve the environment, the RL agent must get an average score of +13 over 100 consecutive episodes.
...
Follow the instructions in `Navigation.ipynb` to get started with training the RL agent!  